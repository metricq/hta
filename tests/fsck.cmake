...
add_executable(hta_fsck_search_test ${CMAKE_CURRENT_LIST_DIR}/fsck_search.cpp)
target_compile_features(hta_fsck_search_test PRIVATE cxx_std_17)
add_test(NAME hta.fsck.search COMMAND hta_fsck_search_test)
if(Python3_Interpreter_FOUND)
    ...
    if(HTA_VALGRIND)
        add_test(NAME hta.fsck.valgrind COMMAND ${CMAKE_COMMAND} -E env
            ...
            Recovery.test_fast_tail_check_avoids_global_raw_probes
            Recovery.test_parallel_modes_match_serial_bytes_and_group_complete_plans
            Recovery.test_parallel_failure_does_not_skip_other_metrics
            Recovery.test_parallel_full_rebuild_matches_serial
        ...
        add_test(NAME hta.fsck.helgrind COMMAND ${CMAKE_COMMAND} -E env
            "HTA_FSCK_VALGRIND=${HTA_VALGRIND}"
            "HTA_FSCK_VALGRIND_TOOL=helgrind"
            "HTA_FSCK_VALGRIND_LOGS=${CMAKE_CURRENT_BINARY_DIR}/fsck-helgrind"
            ${Python3_EXECUTABLE} ${CMAKE_CURRENT_LIST_DIR}/fsck_integration.py
            $<TARGET_FILE:hta_fsck> $<TARGET_FILE:hta_repair> $<TARGET_FILE:hta_fsck_fixture>
            $<TARGET_FILE:hta_fsck_fault>
            Recovery.test_parallel_modes_match_serial_bytes_and_group_complete_plans
            Recovery.test_parallel_failure_does_not_skip_other_metrics
            Recovery.test_parallel_full_rebuild_matches_serial)
        set_tests_properties(hta.fsck.helgrind PROPERTIES TIMEOUT 180 LABELS threads)
    endif()
endif()
